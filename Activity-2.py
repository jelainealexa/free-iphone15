...
survey_info = "Today, you have been chosen to participate in this survey.\n"\
             "We choose 10 random lucky users the chance to win awesome prizes!\n\n"\
             "You only have 2 minutes to participate!\n\n"\
...
footer_label = tk.Label(root, text="© 2023 Totally Legit Online Store. All rights reserved. No scams here! ", font=("Helvetica", 8))
